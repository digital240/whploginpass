...
app.use(function(req, res, next) {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'Content-Type, x-shop-domain, x-user-token');
...
app.post('/api/customer-auth/start', async (req, res) => {
  ...
  try {
    ...
    console.log('[CustomerAPI] URL:', authUrl.substring(0, 100) + '...');
...
require('./gms-user-routes')(app, cache);
